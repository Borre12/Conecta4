document.addEventListener('DOMContentLoaded', () => {
            ...
            squares[i].onclick = function(){
                if(squares[index + 7].classList.contains('taken')){
                    if (currentPlayer === 1) {
                        ...
                        squares[index].classList.add('jugador1')
                        currentPlayer = 2
                        displayCurrentPlayer.innerHTML = currentPlayer
                    } else if (currentPlayer === 2) {
                        squares[index].classList.add('taken')
                        squares[index].classList.add('jugador2')
                        currentPlayer = 1
                        displayCurrentPlayer.innerHTML = currentPlayer
                    }
    ...
    function checkBoard() {
        ...
        for(let y = 0; y < winningArrays.length; y++) {
            ...
            if(square1.classList.contains('jugador1') &&
                square2.classList.contains('jugador1') &&
                square3.classList.contains('jugador1') &&
                square4.classList.contains('jugador1')) {
                result.innerHTML = 'jugador 1 Gano!'
            }
            else if (square1.classList.contains('jugador2') &&
                square2.classList.contains('jugador2') &&
                square3.classList.contains('jugador2') &&
                square4.classList.contains('jugador2')) {
